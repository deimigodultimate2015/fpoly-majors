...
public class CandidateAPI {
	...
	public ResponseEntity<List<CandidateDto>> returnAllCandidateAndResult() {
		return ResponseEntity.ok(candidateService.returnAllCandidateInfoAndResult());
	}
	...
	public ResponseEntity<MappingJacksonValue> returnAllCandidatedAndAnswered() {
		return ResponseEntity.ok(candidateService.returnAllCandidateInfoAndAnswered());
	}
